...
export async function loadModelMobile() {
  try {
      const session = await ort.InferenceSession.create("/model/mobilenetv2_model.onnx");
...
export async function runModelMobile(session, inputData) {
    try {
